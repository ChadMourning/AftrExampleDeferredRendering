...
namespace Aftr
{
   ...
   class Texture;
	...
	class AftrGLRendererDeferred : public AftrGLRendererBase
	{
    public:
        static AftrGLRendererDeferred* New();
        virtual ~AftrGLRendererDeferred();
        ...
        */
        ...
        enum renderType { FINAL, POSITION, NORMAL, COLOR, AMBIENT, DIFFUSE, SPECULAR, DEPTH };
        renderType renderType = FINAL;
     
    protected:
       AftrGLRendererDeferred();
        virtual void onCreate();
        AftrFrameBufferObject* fbo;
        Tex tex;
        ModelMeshSkin skinFinal;
        ModelMeshSkin skinTest;
        ModelMeshSkin skinDepth;
        ModelMeshSkin skinOrtho;
