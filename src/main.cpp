...
#include <vector>
#include <memory>
#include "GLViewTestDeferredRenderer.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewTestDeferredRenderer > glView( Aftr::GLViewTestDeferredRenderer::New( args ) );
